"""
This files contains all functions for types
"""
...
from src.models.types_ import DataKind, NUMERICAL, NONNUMERICAL, INT, HUMAN_GENERATED, COMPUTER_GENERATED, DATE, ALPHABETIC, ALPHANUMERIC, ALL, MULTIPLE_VALUES, \
