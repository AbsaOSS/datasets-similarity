...
from similarity_framework.src.impl.types_functions import is_id, is_numerical, is_bool, get_data_kind, DataKind, is_constant, is_int, is_human_gen, \
...
from similarity_framework.src.models.types_ import NUMERICAL, NONNUMERICAL, DATE, ALPHABETIC, ALL, ALPHANUMERIC, \
